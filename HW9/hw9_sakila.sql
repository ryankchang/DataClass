...
select staff.first_name,staff.last_name,sum(payment.amount) 
	...
	where month(payment.payment_date) = 8 and year(payment.payment_date) = 2005 group by payment.staff_id;
...
#starting with the letters K and Q have also soared in popularity. Use subqueries to display the titles of movies starting with 
#the letters K and Q whose language is English.
##############################################
select * from film;
select * from language;

select film.title from film left join language on film.language_id = language.language_id
